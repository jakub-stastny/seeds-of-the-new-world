...
#+begin_tip "Can the US really default?"
  Which for any other country would mean defaulting on their debt. Since the US is printing the world's reserve currency, it (virtually) cannot default. However in real terms it means devaluing dollar to the point of crashing it.
#+end_tip
